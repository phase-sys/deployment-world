# BUDGET PATTERN_MAX(100.00, 4, 4, 5, yyyy-mm-dd)
...
i = 0
while i < 1000:
    f.write("({0}, {1}, {2}, {3}, \"{4}\"),".format(random.randrange(100, 5001, 100), random.randrange(1,3), random.randrange(1,5), random.randrange(1,6), date_data[i]))
    i += 1
